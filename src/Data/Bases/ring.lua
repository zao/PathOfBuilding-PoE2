...
itemBases["Golden Hoop"] = {
	...
	implicit = "+(8-12) to all [Attributes|Attributes]",
...
itemBases["Iron Ring"] = {
	...
	influenceTags = { shaper = "ring_shaper", elder = "ring_elder", adjudicator = "ring_adjudicator", basilisk = "ring_basilisk", crusader = "ring_crusader", eyrie = "ring_eyrie", cleansing = "ring_cleansing", tangle = "ring_tangle" },
	implicit = "Adds 1 to 4 [Physical|Physical] Damage to [Attack|Attacks]",
...
itemBases["Ruby Ring"] = {
	...
	tags = { ring = true, default = true, },
	influenceTags = { shaper = "ring_shaper", elder = "ring_elder", adjudicator = "ring_adjudicator", basilisk = "ring_basilisk", crusader = "ring_crusader", eyrie = "ring_eyrie", cleansing = "ring_cleansing", tangle = "ring_tangle" },
	implicit = "+(20-30)% to [Resistances|Fire Resistance]",
...
itemBases["Sapphire Ring"] = {
	...
	tags = { ring = true, default = true, },
	influenceTags = { shaper = "ring_shaper", elder = "ring_elder", adjudicator = "ring_adjudicator", basilisk = "ring_basilisk", crusader = "ring_crusader", eyrie = "ring_eyrie", cleansing = "ring_cleansing", tangle = "ring_tangle" },
	implicit = "+(20-30)% to [Resistances|Cold Resistance]",
...
itemBases["Topaz Ring"] = {
	...
	tags = { ring = true, default = true, },
	influenceTags = { shaper = "ring_shaper", elder = "ring_elder", adjudicator = "ring_adjudicator", basilisk = "ring_basilisk", crusader = "ring_crusader", eyrie = "ring_eyrie", cleansing = "ring_cleansing", tangle = "ring_tangle" },
	implicit = "+(20-30)% to [Resistances|Lightning Resistance]",
...
itemBases["Emerald Ring"] = {
	...
	tags = { ring = true, default = true, },
	influenceTags = { shaper = "ring_shaper", elder = "ring_elder", adjudicator = "ring_adjudicator", basilisk = "ring_basilisk", crusader = "ring_crusader", eyrie = "ring_eyrie", cleansing = "ring_cleansing", tangle = "ring_tangle" },
	implicit = "+(120-160) to [Accuracy|Accuracy] Rating",
...
itemBases["Prismatic Ring"] = {
	...
	tags = { ring = true, default = true, },
	influenceTags = { shaper = "ring_shaper", elder = "ring_elder", adjudicator = "ring_adjudicator", basilisk = "ring_basilisk", crusader = "ring_crusader", eyrie = "ring_eyrie", cleansing = "ring_cleansing", tangle = "ring_tangle" },
	implicit = "+(7-10)% to all [ElementalDamage|Elemental] [Resistances]",
...
itemBases["Gold Ring"] = {
	...
	tags = { ring = true, default = true, },
	influenceTags = { shaper = "ring_shaper", elder = "ring_elder", adjudicator = "ring_adjudicator", basilisk = "ring_basilisk", crusader = "ring_crusader", eyrie = "ring_eyrie", cleansing = "ring_cleansing", tangle = "ring_tangle" },
	implicit = "(6-15)% increased [ItemRarity|Rarity of Items] found",
	implicitModTypes = { {  }, },
	req = { level = 40, },
}
